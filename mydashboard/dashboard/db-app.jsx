  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
        ...
        <button className="icon-btn notif-btn" onClick={() => setNotifOpen(o => !o)} style={{ position:'relative' }}
          title="Notifications">
...
function App() {
  ...
  const [tweaks, setTweaksState] = useState(/*EDITMODE-BEGIN*/{"accentColor":"#4F6EF7","compactMode":false}/*EDITMODE-END*/);
  const setTweak = (k, v) => {
