...
function CalendarWidget() {
  ...
  // April 2026: 1st = Wednesday (index 2 if Mon=0)
  const firstDow = 2;
...
Object.assign(window, { KPIRow, ProgressWidget, NotificationsWidget, CalendarWidget, TransactionTable, RegionsWidget });
