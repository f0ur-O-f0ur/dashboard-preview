...
export const REVENUE_LABELS = ['Apr 1','Apr 3','Apr 5','Apr 7','Apr 9','Apr 11','Apr 13','Apr 15','Apr 17','Apr 19','Apr 21','Apr 23','Apr 25']
export const REVENUE_DATA   = [18200,19400,17800,21300,22100,20800,24500,23200,25800,26100,24900,27400,28600]

export const BAR_LABELS = ['Week 1','Week 2','Week 3','Week 4']
export const BAR_WEB    = [42000,51000,47000,58000]
export const BAR_MOBILE = [28000,33000,30000,38000]
export const BAR_API    = [12000,15000,18000,20000]

export const DONUT_DATA   = [42, 28, 18, 12]
export const DONUT_LABELS = ['Organic','Direct','Social','Referral']
export const DONUT_COLORS = ['#4F6EF7','#12B76A','#F79009','#E04444']
...
export function LineChart({ theme }) {
...
export function DonutChart({ theme }) {
  const canvasRef = useRef(null)
  const chartRef  = useRef(null)
